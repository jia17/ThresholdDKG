...
public class PrfBroad implements Runnable{
    ...
    public PrfBroad(String Id,String pwd,String hash1){
        userId=Id;this.pwd=pwd;hash1Pwd=hash1;ipPorts= IdpServer.addrS;
    }

    @Override
    public void run(){
        var hash2= DKG.HashRipe160("1234566"+hash1Pwd);
